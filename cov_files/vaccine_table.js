...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#d3a70f', endColorstr='#f6d04a',GradientType=0 ); /* IE6-9 */
        ...
        .ind-vacc_mp_tbl th:nth-of-type(3),.ind-vacc_mp_tbl th:nth-of-type(6) {
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#a5c9fd', endColorstr='#bde5fc',GradientType=0 ); /* IE6-9 */
        ...
        .ind-vacc_mp_tbl th:nth-of-type(4),.ind-vacc_mp_tbl th:nth-of-type(7) {
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#fe8683', endColorstr='#ff9d9b',GradientType=0 ); /* IE6-9 */
        ...
        .ind-vacc_mp_tbl td:nth-of-type(3),.ind-vacc_mp_tbl td:nth-of-type(6) {
            color: #002c57;
        }

        .ind-vacc_mp_tbl td:nth-of-type(4),.ind-vacc_mp_tbl td:nth-of-type(7) {
            color: #005c25;
        }
        ...
        @media only screen and (max-width: 500px) {
            ...
            .ind-vacc_mp_tbl th, .ind-vacc_mp_tbl td { min-width: 120px; }
            .ind-vacc_mp_tbl {
                height: `+tableheight+`;
                position: relative;
                overflow-y: hidden;
                ...
                <table class="ind-vacc_mp_tbl sortable" id="ind_vacc_mp_tbl">
                    <thead>
                        <tr>
                            ...
                            <th>Total Vaccinated Day Before</th>
                        </tr>
                    </thead><tbody></tbody>
                </table>
...
jQuery('#_vaccinetable').html(styleCss1+addVaccineHtml);
    var gatVaccineData =  '/sites/default/files/covid/vaccine/covid_vaccine_timeline.json';
    var tableVaccineData = '';
    jQuery.ajax({
        type: 'GET',
        url: gatVaccineData + '?' + $.now(),
        dataType: 'json',
        timeout: 6000,
        async: false,  //set false if load map with data
        success: function(response) { 
            var getLastData = response['vaccine_data'].pop();
            ...
            for(var k = 0; k < stateVaccineJsonData.length; k++){
                ...
                tableVaccineData += '<tr><td>'+vaccStateName+'</td><td><p class="mid-wrap">'+numberWithComma(vaccDose1)+'<span class="data-up">'+numberWithComma(diffDose1)+'</span></p></td><td><p class="mid-wrap">'+numberWithComma(vaccDose2)+'<span class="data-up">'+numberWithComma(diffDose2)+'</span></p></td><td><p class="mid-wrap">'+numberWithComma(vaccTotalDoses)+'<span class="data-up">'+numberWithComma(diffTotalDoses)+'</span></p></td><td><p class="mid-wrap">'+numberWithComma(vaccLastTotalDoses)+'</p></td></tr>';
