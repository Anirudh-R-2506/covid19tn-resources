...
/*alert(document.getElementById('_indiatable').innerHTML);
var device = querySt("device") || (document.getElementById('_indiatable').getAttribute('data-device')) || '';
var shgraph = querySt("shgraph") || (document.getElementById('_indiatable').getAttribute('data-shgraph')) || '';
var days = querySt("days") || (document.getElementById('_indiatable').getAttribute('data-days')) || '7';
var hidetable = querySt("hidetable") || (document.getElementById('_indiatable').getAttribute('data-hidetable')) || '';*/
var hidetable = '';
var device = '';
var dm = querySt("dm") || '';
...
/*if(device == 'apps') {
    if ((window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches)||dm==1)  { jQuery('body').addClass('dark-theme');chbckcolor = '#242424'; }
    appsCss = `@media (prefers-color-scheme: dark) {
                    body, .ind-mp_wrap {background-color: #242424;}
                    .ind-mp_tbl tbody tr{ border-bottom-color: #3a3a3a;}
                    .ind-mp_tbl td:nth-of-type(1), .ind-mp_tbl td:nth-of-type(2), .confirmed, .confirmed a, .ind-mp_tbl th:nth-of-type(1), .ind-mp_tbl th:nth-of-type(2){ color: #afafaf;}
                    .ind-mp_tbl th:nth-of-type(1), .ind-mp_tbl th:nth-of-type(2), .ind-mp_tbl th:nth-of-type(3), .ind-mp_tbl th:nth-of-type(4){ border-right-color: #6d6d6d;}
                }
                body.dark-theme,.dark-theme .ind-mp_wrap {background-color: #242424;}
                    .dark-theme .ind-mp_tbl tbody tr{ border-bottom-color: #3a3a3a;}
                    .dark-theme .ind-mp_tbl td:nth-of-type(1),.dark-theme  .ind-mp_tbl td:nth-of-type(2),.dark-theme  .confirmed,.dark-theme .confirmed a,.dark-theme  .ind-mp_tbl th:nth-of-type(1),.dark-theme  .ind-mp_tbl th:nth-of-type(2){ color: #afafaf;}
                    .dark-theme .ind-mp_tbl th:nth-of-type(1),.dark-theme  .ind-mp_tbl th:nth-of-type(2),.dark-theme  .ind-mp_tbl th:nth-of-type(3),.dark-theme  .ind-mp_tbl th:nth-of-type(4){ border-right-color: #6d6d6d;}
            `;
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#fe8683', endColorstr='#ff9d9b',GradientType=0 ); /* IE6-9 */
        ...
        .ind-mp_tbl td{ font-size: 14px;text-transform: capitalize;}
